...
<h2 class="form-signin-heading">注册账号</h2>
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="email" class="form-control" id="input_email" name="input_email" placeholder="123456@qq.com">
    </div>
  </div>
  <div class="form-group">
    <label for="input_password1" class="col-sm-2 control-label">密码</label>
    <div class="col-sm-10">
      <input type="password" class="form-control" id="input_password1" name="input_password1" placeholder="">
    </div>
  </div>
    ...
    <div class="col-sm-10">
      <input type="password" class="form-control" id="input_password2" name="input_password2" placeholder="">
    </div>
  </div>
    <div class="form-group">
    <label for="stu_num" class="col-sm-2 control-label">学号</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="stu_num" name="stu_num" placeholder="1204011010">
    </div>
  </div>
      <div class="form-group">
    <label for="name" class="col-sm-2 control-label">名字</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="name" name="name" placeholder="小华">
    </div>
  </div>
          <div class="form-group">
